	...
	`
		...
		if (allElements && spans) {
            ...
            setTimeout(() => {
                ...
                const drivingLicenseExpandButton = driversDocumentationExpandButtons.find(e => e.textContent.trim() == 'Driving license')
                const carInsuranceExpandButton = driversDocumentationExpandButtons.find(e => e.textContent.trim() == 'Car business insurance')
                const motExpandButton = driversDocumentationExpandButtons.find(e => e.textContent.trim() == 'MOT test check')
                const dvlaExpandButton = driversDocumentationExpandButtons.find(e => e.textContent.trim() == 'DVLA check')
                const carTaxExpandButton = driversDocumentationExpandButtons.find(e => e.textContent.trim() == 'Car Tax')
                        ...
                        <table class="profile__modularTable">
                            ...
                            <table class="profile__modularTable">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="profile__thirdColumn">${dbsUpdateMostRecentDate}</td>
                                    </tr>
                                    <tr>
                            ...
                            <table class="profile_trainingTable">
                                ...
                                <tbody>
                                    ...
                                    <tr> <td>De-escalation/Physical Intervention</td> <td>${PMVAProvider}</td> <td>${isNaN(PMVACompletionDate) ? '' : PMVACompletionDate}</td> <td>${PMVAExpireDate}</td> </tr>
                                </tbody>
                            </table>
